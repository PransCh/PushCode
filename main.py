...
def upload_solution(website, solution, repo):
    try:
        ...
        upload_to_github(
            repo, path, solution['solution'], inspect.cleandoc(problem_info))
        return True
...
def main():
    codeforces_username = input(
        'Enter codeforces username (Press enter if N/A): ')
    ...
    repo_name = input(
        'Enter repository name (Press enter to use "CP-Solutions"): ')
